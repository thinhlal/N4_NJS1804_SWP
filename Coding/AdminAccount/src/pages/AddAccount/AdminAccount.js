...
function AdminAccount() {
  ...
  const handleAddAccount = () => {
    ...
    const usernameExists = accountData.some(account => account.user_name === newAccount.user_name);
    const emailExists = accountData.some(account => account.email === newAccount.email);
    if (usernameExists) newErrors.user_name = 'User name already exists';
